...
>(function DateTimePickerIcon({ className, size, ...props }, ref) {
  ...
  // The ref type gluestack declares here doesn't match the one its own icon accepts
  // (upstream gap in the alpha component). Casting keeps the runtime behaviour intact.
  const iconRef = ref as never;
